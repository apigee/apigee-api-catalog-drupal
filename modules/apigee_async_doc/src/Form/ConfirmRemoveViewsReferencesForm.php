...
namespace Drupal\apigee_async_doc\Form;
...
class ConfirmRemoveViewsReferencesForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'apigee_async_doc_confirm_remove_views_references';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (is_object($view)) {
      ...
      if ($filters['type']['value']['async_doc']) {
        unset($filters['type']['value']['async_doc']);
      }
      if (isset($filters['type_1']) && $filters['type_1']['value']['async_doc']) {
        unset($filters['type_1']['value']['async_doc']);
      }
