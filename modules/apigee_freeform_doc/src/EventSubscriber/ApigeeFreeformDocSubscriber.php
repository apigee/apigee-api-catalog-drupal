...
/**
 * Apigee Free-form Doc event subscriber.
 */
class ApigeeFreeformDocSubscriber implements EventSubscriberInterface {
  ...
  public function configSave(ConfigCrudEvent $event) {
    ...
    if ($config->getName() == 'core.entity_view_display.node.freeform_doc.default') {
      ...
      if (is_object($view)) {
        ...
        if ($filters['type']) {
          $filters['type']['value']['freeform_doc'] = 'freeform_doc';
        }
        if (isset($filters['type_1'])) {
          $filters['type_1']['value']['freeform_doc'] = 'freeform_doc';
        }
