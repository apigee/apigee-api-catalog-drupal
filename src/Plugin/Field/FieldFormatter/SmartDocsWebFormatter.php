 ...
 *
 * @FieldFormatter(
 *   id = "apigee_api_catalog_smartdocs_web",
 *   label = @Translation("SmartDocs Web"),
 *   description = @Translation("Formats OpenAPI specs with SmartDocs Web"),
 *   field_types = {
 *     "file"
 *   }
 * )
 */
class SmartDocsWebFormatter extends FileFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $elements['#attached'] = [
      'library' => [
        ...
        'apigee_api_catalog/smartdocs_web'
      ],
    ];
